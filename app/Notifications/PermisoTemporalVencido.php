...
class PermisoTemporalVencido extends Notification
{
    use Queueable;
...
//            'fin'     => $this->permisoTemporal->ptmp_vigencia_final,
            ...
            'texto'   => 'El <b>permiso temporal</b> de <b>' .
                            $this->permisoTemporal->ptmp_nombre. '</b> con el gafete <b>'. $this->permisoTemporal->GafetePreimpreso->gfpi_numero .'</b> vence hoy, <small class="text-info bold">'. $this->permisoTemporal->ptmp_vigencia_final.'</small>',
