...
class TipoPuerta extends Model
{
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        switch($eventName){
             case 'created':
                $message = 'Creó un Tipo de Puerta ['.$this->getKey().']';
                break;
            case 'updated':
                $message = 'Actualizó un Tipo de Puerta ['.$this->getKey().']';
                break;
            case 'deleted':
                $message = 'Eliminó un Tipo de Puerta ['.$this->getKey().']';
                break;
            default:
