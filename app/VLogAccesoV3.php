...
class VLogAccesoV3 extends Model
{
//    use SoftDeletes;
//    use LogsActivity;


    protected $table  = 'v_log_accesos_v3';
...
//    const DELETED_AT = 'lgac_deleted_at';
    ...
    protected static $logAttributesToIgnore = ['lgac_created_at'];
    ...
    public function Local(){
        return $this->belongsTo('App\Local','lcal_id','lcal_id');
    }
