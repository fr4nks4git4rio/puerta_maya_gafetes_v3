...
class SolicitudesMantenimientoVigentesReport extends BaseReport
{
    ...
    private $view = "pdf-reports.solicitudes-mantenimiento-vigentes";
    ...
    {
        $this->prefijo = "SMTOVIG_".date('YmdHi');
