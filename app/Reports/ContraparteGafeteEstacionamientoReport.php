...
class ContraparteGafeteEstacionamientoReport extends BaseReport
{

    private $gafete = null;

    private $view = "gafetes.contraparte-gafete-estacionamiento";
    ...
    public function setSolicitud(GafeteEstacionamiento $gafete)
    {
