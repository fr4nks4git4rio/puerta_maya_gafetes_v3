...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Equipos y Herramientas
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FEquipoHerramienta = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('equipos-herramientas/form')}}',
            delete_url: '{{url('equipos-herramientas/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el equipo / herramienta <b>'+data.eqher_nombre+'</b>?',
