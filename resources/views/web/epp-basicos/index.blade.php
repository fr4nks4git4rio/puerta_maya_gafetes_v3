...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>EPP Básicos
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FEppBasico = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('epp-basicos/form')}}',
            delete_url: '{{url('epp-basicos/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el EPP básico <b>'+data.eppb_nombre+'</b>?',
