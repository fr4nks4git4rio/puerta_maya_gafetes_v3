...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Medidas de Control de Riesgo
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FMedidaControlRiesgo = {
            key_id:'medcr_id',
            modal_dom: 'modal-form',
            modal_size: 'modal-md',
            form_url: '{{url('medidas-control-riesgo/form')}}',
            delete_url: '{{url('medidas-control-riesgo/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar la medida de control de riesgo <b>'+data.medcr_nombre+'</b>?',
