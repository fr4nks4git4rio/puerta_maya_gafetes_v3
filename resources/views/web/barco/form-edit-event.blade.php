...
<div class="container">
    ...
    {!! Form::model($evento,['id' => 'form-evento','url' =>$url , 'class' => 'form-horizontal']) !!}

        {!! Form::hidden('id', null,["class"=>"form-control", "placeholder" => "", 'readonly'=>true]);!!}
        <div class="form-group row">
            {!! Form::label('fecha', 'Fecha', ['class' => 'col-sm-4 control-label']); !!}
            <div class="col-sm-8">
            {!! Form::text('fecha', substr($evento->fecha_inicio,0,10) ,["class"=>"form-control", "placeholder" => ""]);!!}
            </div>
        </div>
