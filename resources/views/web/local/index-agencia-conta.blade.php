...
@section('title')
<span class="ti-medall-alt">&nbsp;</span>Locales - Agencias Consignatarias
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        jLocal = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/form/agencia')}}',
            delete_url: '{{url('local/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar local <b>'+data.lcal_nombre_comercial+'</b>?',
