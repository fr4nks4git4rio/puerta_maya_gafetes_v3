...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                {!! Form::label('gest_numero_nfc', 'Número Tarjeta', ['class' => 'col-sm-4 control-label']); !!}
                <div class="col-sm-8">
                    {!! Form::text('gest_numero_nfc', null,["class"=>"form-control"]);!!}
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <p class="alert alert-info text-center">
                    Esta acción marcará que el gafete ya ha sido impreso correctamente.
                </p>
            </div>
            ...
            <div class="row">
                @foreach($puertas as $puerta)
                    <div class="col-sm-6 form-group">
                        ...
                        {{$puerta->door_nombre}}, Tipo: {{$puerta->door_tipo}}, Controladora: {{$puerta->Controladora->ctrl_nombre}}
                    </div>
                @endforeach
            </div>
        </div>
