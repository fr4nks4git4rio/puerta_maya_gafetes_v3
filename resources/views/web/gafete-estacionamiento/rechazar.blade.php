...
{{--                </div>--}}
                ...
                <div class="form-group row">
                    {!! Form::label('gest_comentario_admin', 'Comentario de Rechazo' , ['class' => 'col-sm-4 control-label']); !!}
                    <div class="col-sm-8">
                    {!! Form::textarea('gest_comentario_admin', null,["class"=>"form-control", "size"=>"50x2"]);!!}
                    </div>
                </div>
