...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Tipos de Mantenimiento
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FTipoMantenimiento = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('tipos-mantenimiento/form')}}',
            delete_url: '{{url('tipos-mantenimiento/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el tipo de mantenimiento <b>'+data.tmtt_nombre+'</b>?',
