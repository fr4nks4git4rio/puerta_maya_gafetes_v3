...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Tipos de Comprobante
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JTipoComprobante = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/tipos_comprobante/form')}}',
            delete_url: '{{url('local/conta/tipos_comprobante/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar tipo de comprobante <b>'+data.descripcion+'</b>?',
