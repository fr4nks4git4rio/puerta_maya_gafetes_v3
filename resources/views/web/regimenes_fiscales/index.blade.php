...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Regímenes Fiscales
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JRegimenFiscal = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/regimenes_fiscales/form')}}',
            delete_url: '{{url('local/conta/regimenes_fiscales/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar régimen fiscal <b>'+data.descripcion+'</b>?',
