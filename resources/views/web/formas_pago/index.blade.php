...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Formas de Pago
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JFormaPago = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/formas_pago/form')}}',
            delete_url: '{{url('local/conta/formas_pago/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar forma de pago <b>'+data.descripcion+'</b>?',
