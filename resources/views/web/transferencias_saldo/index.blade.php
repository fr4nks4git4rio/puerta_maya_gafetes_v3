...
@section('title')
<span class="zmdi zmdi-swap">&nbsp;</span>Transferencias de Pago
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JTransferenciaPago = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('transferencias-saldo/form')}}',
            delete_url: '{{url('transferencias-saldo/delete')}}',
...
//                $this.handleDoubleClick();
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar método de pago <b>'+data.descripcion+'</b>?',
