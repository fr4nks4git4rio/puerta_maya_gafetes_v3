...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Riesgos Asociados
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FRiesgoAsociado = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('riesgos-asociados/form')}}',
            delete_url: '{{url('riesgos-asociados/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el riesgo asociado <b>'+data.rasoc_nombre+'</b>?',
