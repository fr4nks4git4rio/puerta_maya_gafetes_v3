    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    {!! Form::text('pmtt_vigencia_inicial', Carbon\Carbon::now()->addDays(1)->format('Y-m-d'), [
                        'class' => 'form-control',
                        'placeholder' => '',
                        'readonly' => true,
                    ]) !!}
...
<div class="form-group row">
            ...
            <div class="form-group row">
                {!! Form::label('pmtt_comentario_admon', 'Comentario de rechazo', ['class' => 'col-sm-4 control-label']) !!}
                <div class="col-sm-8">
