...
@section('title')
    ...
    <br><small>Perfil de Mantenimiento</small>
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('filter-local', $locales, null, [
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            jPermiso = {
                ...
                modal_size: 'modal-lg',
                detalles_url: '{{ url('permiso-mantenimiento/detalles') }}',
                approve_url: '{{ url('permiso-mantenimiento/form-aprobar-mantenimiento') }}',
                reject_url: '{{ url('permiso-mantenimiento/form-rechazar') }}',
                ...
                handleDatatableButtons: function() {
                    ...
                    $(".dataTable").on('click', '.btn-detalles', function() {
                        let id = $(this).data('id');
                ...
                showApproveModal: function(id) {
                    let $this = this;
                    let url = $this.approve_url + '/' + id;
                    APModal.open({
                        dom: $this.modal_dom,
                        title: 'Aprobar permiso de mantenimiento',
                        url: url,
                        size: $this.modal_size
                    });
                },
                ...
                showRejectModal: function(id) {
                    let $this = this;
                    let url = $this.reject_url + '/' + id;
                    APModal.open({
                        dom: $this.modal_dom,
                        title: 'Rechazar permiso de mantenimiento',
                        url: url,
                        size: $this.modal_size
                    });
                },
