...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Categorías de Accesos
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JCAcceso = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('cat-acceso/form')}}',
            delete_url: '{{url('cat-acceso/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar acceso <b>'+data.cacs_descripcion+'</b>?',
