        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    {!! Form::label('ptmp_gfpi_id', 'Gafete', ['class' => 'col-sm-4 control-label']); !!}
                    <div class="col-sm-8">
                    {!! Form::select('ptmp_gfpi_id', $gafetes ,  null , ["class"=>"form-control select2-control",
                                             "style" => "width: 100%" ])!!}
                    </div>
                </div>
