...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Uso Cfdis
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JCfdi = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/cfdis/form')}}',
            delete_url: '{{url('local/conta/cfdis/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar uso cfdi <b>'+data.descripcion+'</b>?',
