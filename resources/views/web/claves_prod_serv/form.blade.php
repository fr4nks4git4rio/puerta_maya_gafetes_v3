<div class="container">
    ...
    {!! Form::model($clave_prod_serv,['id' => 'form-clave-prod-serv','url' =>$url , 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group row">
        {!! Form::label('palabras_similares', 'Palabras Similares', ['class' => 'col-sm-3 control-label']); !!}
        <div class="col-sm-9">
            {!! Form::text('palabras_similares', null,["class"=>"form-control", "placeholder" => ""]);!!}
        </div>
    </div>
