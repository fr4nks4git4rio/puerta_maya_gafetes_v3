...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Claves Prod. Serv.
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JClaveProdServ = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/claves_prod_servs/form')}}',
            delete_url: '{{url('local/conta/claves_prod_servs/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar clave prod. serv. <b>'+data.descripcion+'</b>?',
