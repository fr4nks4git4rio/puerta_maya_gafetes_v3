...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Trabajos Específicos
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FTrabajoEspecifico = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('trabajos-especificos/form')}}',
            delete_url: '{{url('trabajos-especificos/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el trabajo específico <b>'+data.tesp_nombre+'</b>?',
