...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Actividades de Alto Riesgo
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FActAltoRiesgo = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('actividades-alto-riesgo/form')}}',
            delete_url: '{{url('actividades-alto-riesgo/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar la actividad de alto riesgo <b>'+data.actar_nombre+'</b>?',
