...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Bancos
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JBanco = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/bancos/form')}}',
            delete_url: '{{url('local/conta/bancos/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar banco <b>'+data.nombre+'</b>?',
