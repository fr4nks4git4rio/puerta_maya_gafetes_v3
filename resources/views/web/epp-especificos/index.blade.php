...
@section('title')
    <span class="zmdi zmdi-shield-security">&nbsp;</span>EPP Específicos
@endsection
                        ...
                        <div class="col-sm-12">
                            <div class="btn-group">
                                ...
                                <div class="btn btn-custom btn-trans waves-effect" id="btn-remove"> <i
                                        class="zmdi zmdi-minus-circle-outline">&nbsp;</i>Eliminar</div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            FEppEspecifico = {
                ...
                modal_size: 'modal-md',
                form_url: '{{ url('epp-especificos/form') }}',
                delete_url: '{{ url('epp-especificos/delete') }}',
                ...
                doRemove: function(data) {
                    ...
                    APAlerts.confirm({
                        message: '¿Eliminar el EPP específico <b>' + data.eppb_nombre + '</b>?',
