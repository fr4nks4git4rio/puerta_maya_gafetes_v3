    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    {!! Form::text('sgft_numero', null,["class"=>"form-control"]);!!}
                </div>
            </div>
            ...
            <div class="row">
                @foreach($puertas as $puerta)
                    <div class="col-sm-4 form-group"
                            {{--@if($solicitud->Local->Acceso->cacs_id !== 1 && $puerta->door_id != 5) hidden @endif--}}>
                        <input type="checkbox" name="puerta_{{$puerta->door_id}}" @if($puerta->door_tipo === 'PEATONAL') checked @endif>
