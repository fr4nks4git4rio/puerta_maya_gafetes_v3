...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Claves Unidades
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        JClaveUnidad = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('local/conta/claves_unidades/form')}}',
            delete_url: '{{url('local/conta/claves_unidades/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar clave unidad <b>'+data.nombre+'</b>?',
