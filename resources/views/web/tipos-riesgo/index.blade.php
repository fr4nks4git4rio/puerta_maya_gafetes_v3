...
@section('title')
<span class="zmdi zmdi-shield-security">&nbsp;</span>Tipos de Riesgo
@endsection
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        FTipoRiesgo = {
            ...
            modal_size: 'modal-md',
            form_url: '{{url('tipos-riesgo/form')}}',
            delete_url: '{{url('tipos-riesgo/delete')}}',
            ...
            doRemove: function(data){
                ...
                APAlerts.confirm({
                    message: '¿Eliminar el tipo de riesgo <b>'+data.trgo_nombre+'</b>?',
