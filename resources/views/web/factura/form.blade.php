            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('fact_nombre_receptor', auth()->user()->Local->lcal_razon_social ,["class"=>"form-control", "placeholder" => "", "readonly"=>true]);!!}
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('fact_rfc_receptor', auth()->user()->Local->lcal_rfc ,["class"=>"form-control", "placeholder" => "", "readonly"=>true]);!!}
                    </div>
                </div>
