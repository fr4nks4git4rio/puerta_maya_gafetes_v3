            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs mt-2">
                        <li class="nav-item">
                            <a data-toggle="tab" href="#lft-tab-tarjetas" aria-expanded="true"
                               class="nav-link show text-center active" id="nav-tarjetas">
                                <b>Tarjetas</b></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a data-toggle="tab" href="#lft-tab-accesos" aria-expanded="false"
                               class="nav-link show text-center" id="nav-accesos">
                                <b>Log de acceso</b></a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="lft-tab-tarjetas" class="tab-pane show active">
                            <div class="row">
                                ...
                                <div class="col-sm-2 d-inline-flex mb-1 offset-5">
                                    <label for="" class="mt-1">
                                        Tarjetas Vigentes:
                                        <input type="checkbox" @if($filtros['tarjetasVigentes']) checked
                                               @endif id="checkbox-tarjetas-vigentes">
                                    </label>
                                </div>
                                ...
                                @foreach($tarjetas as $t)
                                    ...
                                    <tr>
                                        ...
                                        <span class="btn-group">
                                            <span class="btn btn-sm btn-primary btn-create-card mr-2" id="btn-create-card-{{$t->numero_rfid}}"
                                                  title="Crear & Autorizar" data-number="{{$t->numero_rfid}}"
                        ...
                        <!--Tab Accesos-->
                        <div id="lft-tab-accesos" class="tab-pane show">
                            {{-- <p class="text-main text-semibold">Roles y Permisos</p> --}}
            ...
            jGateController = {
                ...
                init: function () {
                    ...
                    $('#input-search-tarjetas').off().on('keyup', function (event) {
                        if (event.key === 'Enter') {
                            let checked = document.getElementById('checkbox-tarjetas-vigentes').checked ? 1 : '';
                            let perPage = $('#perPageTarjeta').val();
                            window.location.href = "/gate-controller?search_tarjeta=" + $(this).val() + "&tarjetasVigentes=" + checked + "&perPageTarjeta=" + perPage;
                        }
                    });
                    ...
                    $('#checkbox-tarjetas-vigentes').off().on('click', function (event) {
                        ...
                        let perPage = $('#perPageTarjeta').val();
                        window.location.href = "/gate-controller?search_tarjeta=" + $('#input-search-tarjetas').val() + "&tarjetasVigentes=" + checked + "&perPageTarjeta=" + perPage;
                    });
                    ...
                    $('.checkbox-card').off().on('click', function (event) {
                        ...
                        if ($this.cards_selected.length > 0) {
                            document.getElementById('btn-create-card-lote').className = document.getElementById('btn-create-card-lote').className.replace(' disabled', '');
                        } else {
                            document.getElementById('btn-create-card-lote').className = document.getElementById('btn-create-card-lote').className + ' disabled';
                        }
                    });
...
//                            }
                ...
                createCard: function (cardPin, cardNumber) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            $('#btn-create-card-'+cardNumber).html('<i class="fa fa-check"></i>');
                        }
                    });
                ...
                createCardLote: function (pines) {
                    ...
                    $('#crear-autorizar-div').html('<span class="btn btn-primary disabled"> <i class="fa fa-spin fa-spinner"></i> Creando y Autorizando</span>')
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            $('#crear-autorizar-div').html('<span class="btn btn-primary" id="btn-create-card-lote"> <i class="fa fa-chain"></i> Crear & Autorizar por Lotes</span>');
                        }
                    });
