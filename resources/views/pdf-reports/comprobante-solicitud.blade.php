            ...
            <table class="table table-bordered mt-5">
                <tbody>
                    <tr>
                        ...
                        <td colspan="3"> {{$solicitud->sgft_nombre  }}</td>
                        <th colspan="3"> Local </th>
                        <td colspan="3"> {{$solicitud->Local->lcal_nombre_comercial}}</td>
                    </tr>
                    <tr>
                        <th colspan="3"> Tipo de Gafete</th>
                        <td colspan="3" class="text-left"> {{ $solicitud->sgft_tipo }}</td>
                        <th colspan="3"> Costo gafete</th>
                        <td colspan="3" class="text-left"> $ {{ number_format($solicitud->sgft_costo_tarifa,2) }}</td>
                    </tr>
