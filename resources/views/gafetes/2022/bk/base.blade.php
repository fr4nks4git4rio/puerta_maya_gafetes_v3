...
@section('content')
    ...
    <div class="page-container" style="padding-bottom:1px;">
            ...
            <tr style="
                ...
                <td colspan="2">
                    <div class="text-center" style="">
                        <h3 style="color: #000; font-size:20px; line-height: 22px" class="text-uppercase">
                                {{ $gafete->sgft_nombre }}
                ...
                <td>
                    <div class="text-left"
                            ...
                            /*padding-bottom: 10px*/
                                "
                    >
                        {!! QrCode::size(70)->generate($qr_text); !!}
                    </div>
                </td>
                <td  class="text-center">
                    VIGENCIA <br>
                    <b style="font-size: 20px; color: black;">{{substr($gafete->sgft_fecha,0,4)}}</b>
                </td>
            </tr>
