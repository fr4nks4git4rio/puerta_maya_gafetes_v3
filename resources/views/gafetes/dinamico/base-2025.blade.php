...
{{--                        <h5 style="font-size:16px; font-weight: 600; color: rgb(29,79,123); line-height: 15px"> PUERTA MAYA <br> <span style="font-size: 12px; color: #000; font-weight: 200;">TERMINAL MARÍTIMA</span></h5>--}}
                ...
                <td colspan="2">
                    <div>
                        <img src="{{$gafete->sgft_foto_web}}" alt="" class="foto"
                             style="border: 1px dotted transparent;width: 37.5mm;height: 37.5mm; margin-left: 22mm; margin-top: 3.5mm">
                    </div>
                </td>
            </tr>
            ...
            <tr style="
                ...
                <td colspan="3">
                    <div class="text-center">
                        <h3 style="color: #000; font-size:20px; font-weight: 700; line-height: 1; margin-top: -1mm"
            ...
            <tr style="
                ...
                <td colspan="3" style="padding-right: 40px">
                    <div class="text-center">
                        <h3 style="color: #000; font-size:17px;line-height: 1; font-weight: 700;"
                            class="text-uppercase">
                            {{ $gafete->sgft_nombre }}
                        </h3>
                    </div>
            ...
            <tr style="
                ...
                <td colspan="3">
                    <div class="text-center" style="margin-top: -4mm">
                        <h3 style="color: #000; font-size:17px; font-weight: 700; margin-top: 7mm"
                            class="text-uppercase">
            ...
            <tr style="border: 1px solid transparent">
                <td class="text-center" colspan="3" style="color: #000; font-size: 20px; font-weight: 700; line-height: 1;">
                    <div style="margin-top: 0mm">{{$anio_impresion}}</div>
                </td>
            </tr>
