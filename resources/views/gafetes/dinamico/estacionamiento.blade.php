...
{{--                    </div>--}}
            ...
            <tr>
                <td colspan="3" style=" color: {{$color}}; font-size: 18px; line-height: 1; padding-top: 20px">
                    <div class="text-center">
                        <h3 style="color:#000; margin-bottom: 0">{{$gafete->Local->lcal_nombre_comercial}}</h3>
                    </div>
                    <div class="text-center">
                        ...
                        <p style="margin-bottom: 0; margin-top: 10px"><span style="color: {{$color}}; font-weight: bold; font-size: 16px"> VIGENCIA &nbsp;{{ $gafete->gest_anio  }}</span></p>
                    </div>
                </td>
            </tr>
