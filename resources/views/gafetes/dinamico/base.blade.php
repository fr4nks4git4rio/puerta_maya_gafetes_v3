                ...
                <td colspan="2">
                    <div>
                        <img src="{{$gafete->sgft_foto_web}}" alt="" class="foto"
                             style="border: 1px dotted transparent;width: 45mm;height: 52mm;">
                    </div>
                    <div class="text-center">
{{--                        <h3 style="font-weight: 700; color: #fff; margin-bottom: 0 !important; margin-top: 10px">{{ trim($gafete->Local->lcal_nombre_comercial) }}</h3>--}}
                    </div>
                </td>
            </tr>
            ...
            <tr style="
                ...
                <td colspan="3">
                    <div class="text-center" style="padding-top: 15px">
                        <h3 style="color: #fff; font-size:22px; font-weight: 700; line-height: 1;"
            ...
            <tr style="
                ...
                <td colspan="3">
                    <div class="text-center" style="margin-top: -10px">
                        <h3 style="color: #000; font-size:22px;line-height: 1; font-weight: 900;"
                            class="text-uppercase">
                            {{ $gafete->sgft_nombre }}
                        </h3>
                        <h3 style="color: #000; font-size:20px; font-weight: 500"
                            class="text-uppercase">
            ...
            <tr style="border: 1px solid transparent; padding-bottom: 0">
                <td class="text-center" colspan="3" style="color: #fff; font-size: 20px; font-weight: 700; line-height: 1">
                    VIGENCIA {{$anio_impresion}}
                </td>
            </tr>
