...
{{--                    </div>--}}
            ...
            <tr>
                <td colspan="3">
                    <div class="text-center" style="margin-top: -10px; padding-left: 170px">
                        <h5 style="margin-bottom: 0; color: #000; font-size: 20px">{{ $gafete->gest_anio  }}</h5>
                        <h5 style="margin-bottom: 0; color: #000; font-size: 16px; line-height: 1">{{$gafete->Local->lcal_nombre_comercial}}</h5>
                        <h5 style="margin-bottom: 0; color: #000; font-size: 16px">
                            {{ $gafete->gest_numero  }}
